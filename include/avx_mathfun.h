/*
 *  AVX and AVX2 implementation of sin, cos, sincos, exp and log
 *
 *  This software was modified from the Garberoglio version by making
 *  it to work with both gcc and clang. See the readme for details.
 *  These changes are:
